...
bool my_mas__srv__load_file__request__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_mas.srv._load_file.LoadFile_Request", full_classname_dest, 38) == 0);
  }
  my_mas__srv__LoadFile_Request * ros_message = _ros_message;
  {  // a
...
{
  /* NOTE(esteve): Call constructor of LoadFile_Request */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_mas.srv._load_file");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LoadFile_Request");
...
{
  /* NOTE(esteve): Call constructor of LoadFile_Response */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_mas.srv._load_file");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "LoadFile_Response");
    assert(pymessage_class);
    Py_DECREF(pymessage_module);
    _pymessage = PyObject_CallObject(pymessage_class, NULL);
    Py_DECREF(pymessage_class);
