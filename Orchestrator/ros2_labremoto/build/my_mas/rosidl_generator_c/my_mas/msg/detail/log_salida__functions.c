...
my_mas__msg__LogSalida__create()
{
  ...
  my_mas__msg__LogSalida * msg = (my_mas__msg__LogSalida *)allocator.allocate(sizeof(my_mas__msg__LogSalida), allocator.state);
  if (!msg) {
    return NULL;
  }
  memset(msg, 0, sizeof(my_mas__msg__LogSalida));
  bool success = my_mas__msg__LogSalida__init(msg);
  if (!success) {
...
my_mas__msg__LogSalida__Sequence__init(my_mas__msg__LogSalida__Sequence * array, size_t size)
{
  ...
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_mas__msg__LogSalida * data = NULL;

  if (size) {
    data = (my_mas__msg__LogSalida *)allocator.zero_allocate(size, sizeof(my_mas__msg__LogSalida), allocator.state);
    if (!data) {
      return false;
    }
    ...
    size_t i;
    for (i = 0; i < size; ++i) {
      bool success = my_mas__msg__LogSalida__init(&data[i]);
      if (!success) {
        break;
      }
    }
    if (i < size) {
      ...
      for (; i > 0; --i) {
        my_mas__msg__LogSalida__fini(&data[i - 1]);
      }
...
my_mas__msg__LogSalida__Sequence__fini(my_mas__msg__LogSalida__Sequence * array)
{
  ...
  if (array->data) {
    ...
    for (size_t i = 0; i < array->capacity; ++i) {
      my_mas__msg__LogSalida__fini(&array->data[i]);
    }
...
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  my_mas__msg__LogSalida__Sequence * array = (my_mas__msg__LogSalida__Sequence *)allocator.allocate(sizeof(my_mas__msg__LogSalida__Sequence), allocator.state);
  if (!array) {
    return NULL;
  }
  bool success = my_mas__msg__LogSalida__Sequence__init(array, size);
  if (!success) {
...
my_mas__msg__LogSalida__Sequence__destroy(my_mas__msg__LogSalida__Sequence * array)
{
  rcutils_allocator_t allocator = rcutils_get_default_allocator();
  if (array) {
    my_mas__msg__LogSalida__Sequence__fini(array);
  }
  allocator.deallocate(array, allocator.state);
}
...
my_mas__msg__LogSalida__Sequence__are_equal(const my_mas__msg__LogSalida__Sequence * lhs, const my_mas__msg__LogSalida__Sequence * rhs)
{
  ...
  for (size_t i = 0; i < lhs->size; ++i) {
    if (!my_mas__msg__LogSalida__are_equal(&(lhs->data[i]), &(rhs->data[i]))) {
      return false;
    }
  }
  return true;
  ...
  my_mas__msg__LogSalida__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    const size_t allocation_size =
      input->size * sizeof(my_mas__msg__LogSalida);
    rcutils_allocator_t allocator = rcutils_get_default_allocator();
    my_mas__msg__LogSalida * data =
      (my_mas__msg__LogSalida *)allocator.reallocate(
    ...
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!my_mas__msg__LogSalida__init(&output->data[i])) {
        // If initialization of any new item fails, roll back
        // all previously initialized items. Existing items
        // in output are to be left unmodified.
        for (; i-- > output->capacity; ) {
          my_mas__msg__LogSalida__fini(&output->data[i]);
        }
        return false;
      }
    }
  ...
  for (size_t i = 0; i < input->size; ++i) {
    if (!my_mas__msg__LogSalida__copy(
