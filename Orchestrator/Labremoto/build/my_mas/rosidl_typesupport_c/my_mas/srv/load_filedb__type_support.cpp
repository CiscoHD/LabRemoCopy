...
static const _LoadFiledb_Request_type_support_symbol_names_t _LoadFiledb_Request_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_mas, srv, LoadFiledb_Request)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_mas, srv, LoadFiledb_Request)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_mas, srv, LoadFiledb_Request)() {
  return &::my_mas::srv::rosidl_typesupport_c::LoadFiledb_Request_message_type_support_handle;
}
...
static const _LoadFiledb_Response_type_support_symbol_names_t _LoadFiledb_Response_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_mas, srv, LoadFiledb_Response)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_mas, srv, LoadFiledb_Response)),
  }
};
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_c, my_mas, srv, LoadFiledb_Response)() {
  return &::my_mas::srv::rosidl_typesupport_c::LoadFiledb_Response_message_type_support_handle;
}
...
static const _LoadFiledb_type_support_symbol_names_t _LoadFiledb_service_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, my_mas, srv, LoadFiledb)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_introspection_c, my_mas, srv, LoadFiledb)),
  }
};
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_c, my_mas, srv, LoadFiledb)() {
  return &::my_mas::srv::rosidl_typesupport_c::LoadFiledb_service_type_support_handle;
}
