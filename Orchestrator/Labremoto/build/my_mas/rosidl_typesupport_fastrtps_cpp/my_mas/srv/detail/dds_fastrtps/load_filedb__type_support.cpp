...
#include "my_mas/srv/detail/load_filedb__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = my_mas::srv::LoadFiledb_Request;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_mas::srv::LoadFiledb_Request *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<my_mas::srv::LoadFiledb_Request *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LoadFiledb_Request__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_mas::srv::LoadFiledb_Request *>(
...
static size_t _LoadFiledb_Request__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LoadFiledb_Request(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LoadFiledb_Request__callbacks = {
  "my_mas::srv",
  "LoadFiledb_Request",
...
static rosidl_message_type_support_t _LoadFiledb_Request__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoadFiledb_Request__callbacks,
...
{
  return &my_mas::srv::typesupport_fastrtps_cpp::_LoadFiledb_Request__handle;
}
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    // We still need to check that the in-memory alignment
    // is the same as the CDR mandated alignment.
    using DataType = my_mas::srv::LoadFiledb_Response;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const my_mas::srv::LoadFiledb_Response *>(
    untyped_ros_message);
  return cdr_serialize(*typed_message, cdr);
}
...
{
  auto typed_message =
    static_cast<my_mas::srv::LoadFiledb_Response *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _LoadFiledb_Response__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const my_mas::srv::LoadFiledb_Response *>(
...
static size_t _LoadFiledb_Response__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_LoadFiledb_Response(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _LoadFiledb_Response__callbacks = {
  "my_mas::srv",
  "LoadFiledb_Response",
...
static rosidl_message_type_support_t _LoadFiledb_Response__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoadFiledb_Response__callbacks,
  get_message_typesupport_handle_function,
};
...
{
  return &my_mas::srv::typesupport_fastrtps_cpp::_LoadFiledb_Response__handle;
}
...
static service_type_support_callbacks_t _LoadFiledb__callbacks = {
  "my_mas::srv",
  "LoadFiledb",
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_mas, srv, LoadFiledb_Request)(),
  ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_mas, srv, LoadFiledb_Response)(),
...
static rosidl_service_type_support_t _LoadFiledb__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_LoadFiledb__callbacks,
...
{
  return &my_mas::srv::typesupport_fastrtps_cpp::_LoadFiledb__handle;
}
