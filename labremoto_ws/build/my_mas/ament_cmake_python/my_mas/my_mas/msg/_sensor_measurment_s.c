...
bool my_mas__msg__sensor_measurment__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_mas.msg._sensor_measurment.SensorMeasurment", full_classname_dest, 46) == 0);
  }
  my_mas__msg__SensorMeasurment * ros_message = _ros_message;
  {  // temperature
...
{
  /* NOTE(esteve): Call constructor of SensorMeasurment */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_mas.msg._sensor_measurment");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "SensorMeasurment");
