...
static const _SensorMeasurment_type_support_symbol_names_t _SensorMeasurment_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, my_mas, msg, SensorMeasurment)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, my_mas, msg, SensorMeasurment)),
  }
};
...
{
  return &::my_mas::msg::rosidl_typesupport_cpp::SensorMeasurment_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, my_mas, msg, SensorMeasurment)() {
  return get_message_type_support_handle<my_mas::msg::SensorMeasurment>();
}
