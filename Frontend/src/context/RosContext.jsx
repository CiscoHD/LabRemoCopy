...
import { ip_server } from "./Reducer/reducer";
...
export function RosProvider(props) {
  ...
  const [consoleLog, setConsoleLog] = useState([
    {
      lstnr: "Listener #1",
      mssg: `La consola ${isConnected ? "" : "NO"} se ha conectado 
  ...
  const ros = new ROSLIB.Ros({ encoding: "UTF-8", url: defaultConfig.url });
  ...
  ros.on("close", function () {
    ...
    if (
      ...
      setConsoleLog([
        ...
        {
          lstnr: "Listener #1",
          mssg: "La consola NO se ha conectado :(",
        },
      ]);
    }
  ...
  listener.subscribe(function (message) {
    console.log(
      "Received message on " + listener.name + ": " + message.logsalida
    );
    setConsoleLog([
      ...consoleLog,
      {
  ...
  return (
    <RosContext.Provider
      value={{
        ...
        pubMessage,
        CargaHexpubMessage,
        TransformBitTopicpubMessage,
        CargaBitTopicpubMessage,
        // Variables
        consoleLog,
        //Functions
        setConsoleLog,
